...
public enum ICMPCode {
	...
	public static ICMPCode fromCodeForType3(int code) {
		switch(code) {
		case 0:
	...
	public static ICMPCode fromCodeForType5(int code) {
		switch(code) {
		case 0:
	...
	public static ICMPCode fromCodeForType6(int code) {
		switch(code) {
		case 0:
	...
	public static ICMPCode fromCodeForType9(int code) {
		switch(code) {
		case 0:
	...
	public static ICMPCode fromCodeForType11(int code) {
		switch(code) {
		case 0:
	...
	public static ICMPCode fromCodeForType12(int code) {
		switch(code) {
		case 0:
	...
	public static ICMPCode fromCodeForType40(int code) {
		switch(code) {
		case 0:
			return BAD_SPI;
		case 1:
