...
public class BrokerUtilsIntegrationTest {
    ...
    @Test
    public void shouldHaveBootstraServers() {
    ...
    public static class TestConfiguration {
        ...
        @Bean
        @Autowired
        public KafkaBrokerClusterProperties kafkaBrokerClusterProperties(final KafkaBrokerHostProperties kafkaBrokerHostProperties) {
