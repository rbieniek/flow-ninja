...
public class Netflow9PacketDecoderTest {
    ...
    public void decodeDataTemplateOneDataFlowDatagram() throws Exception {
        ...
        assertDataFlowRecord(it, FieldType.PROTOCOL, new EnumCodeValue<>(IPProtocol.UDP, 0x11));
        assertDataFlowRecord(it, FieldType.SRC_TOS, new EnumCodeValue<>(IPTypeOfService.CS0, 0x00));
        ...
        assertDataFlowRecord(it, FieldType.DIRECTION, new EnumCodeValue<>(FlowDirection.EGRESS, 0x01));
    ...
    public void decodeDataTemplateTwoDataFlowDatagram() throws Exception {
        ...
        assertDataFlowRecord(it, FieldType.TCP_FLAGS, TCPFLags.class, TCPFLags.ACK);
        assertDataFlowRecord(it, FieldType.DIRECTION, new EnumCodeValue<>(FlowDirection.INGRESS, 0x00));
        assertDataFlowRecord(it, FieldType.DST_AS, new Integer(0));
        assertDataFlowRecord(it, FieldType.SRC_AS, new Integer(0));
    ...
    public void decodeDataAndOptionsTemplateOneDataFlowOneOptionFlowDatagram() throws Exception {
        channel.writeInbound(channel.alloc().buffer().writeBytes(dataAndOptionsTemplateOneDataFlowOneOptionFlowDatagram));
        ...
        assertDataFlowRecord(dataIt, FieldType.PROTOCOL, new EnumCodeValue<>(IPProtocol.UDP, 0x11));
        assertDataFlowRecord(dataIt, FieldType.SRC_TOS, new EnumCodeValue<>(IPTypeOfService.CS0, 0x00));
        ...
        assertDataFlowRecord(dataIt, FieldType.DIRECTION, new EnumCodeValue<>(FlowDirection.EGRESS, 0x01));
    ...
    private <T> void assertDataFlowRecord(final Iterator<DataFlowRecord> it, final FieldType type, final Class<T> clazz, final T... values) {
        DataFlowRecord dfr;
