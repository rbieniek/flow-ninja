...
public class TemplateRegistryActorIntegrationTest {
	...
	@Test
	public void shouldFireTemplateListenerOnDataTemplate() {
		...
		final ActorRef notified = springActorProducer.createActor(MessageSinkActor.class,
				TemplateRegistryActor.DataTemplateAvailableRequest.class, 1, notifiedCompletable);

		templateRegistryActor.tell(TemplateRegistryActor.AddNotifiedRequest.builder().notified(notified).build(), null);
		templateRegistryActor.tell(TemplateRegistryActor.StoreDataTemplateRequest.builder()
				.dataTemplates(Arrays.asList(DataTemplate.builder().flowsetId(1).build())).build(), null);
	...
	@Test
	public void shouldFireTemplateListenerOnTwoDataTemplate() {
		final CompletableFuture<List<TemplateRegistryActor.DataTemplateAvailableRequest>> notifiedCompletable = new CompletableFuture<>();
		final ActorRef notified = springActorProducer.createActor(MessageSinkActor.class,
				TemplateRegistryActor.DataTemplateAvailableRequest.class, 2, notifiedCompletable);

		templateRegistryActor.tell(TemplateRegistryActor.AddNotifiedRequest.builder().notified(notified).build(), null);
		templateRegistryActor.tell(TemplateRegistryActor.StoreDataTemplateRequest.builder().dataTemplates(
				Arrays.asList(DataTemplate.builder().flowsetId(1).build(), DataTemplate.builder().flowsetId(2).build()))
				.build(), null);
	...
	@Test
	public void shouldFireTemplateListenerOnOptionsTemplate() {
		...
		final ActorRef notified = springActorProducer.createActor(MessageSinkActor.class,
				TemplateRegistryActor.OptionsTemplateAvailableRequest.class, 1, notifiedCompletable);

		templateRegistryActor.tell(TemplateRegistryActor.AddNotifiedRequest.builder().notified(notified).build(), null);
		templateRegistryActor.tell(TemplateRegistryActor.StoreOptionTemplateRequest.builder()
				.optionsTemplates(Arrays.asList(OptionsTemplate.builder().flowsetId(1).build())).build(), null);
	...
	@Test
	public void shouldFireTemplateListenerOnTwoOptionsTemplate() {
		final CompletableFuture<List<TemplateRegistryActor.OptionsTemplateAvailableRequest>> notifiedCompletable = new CompletableFuture<>();
		final ActorRef notified = springActorProducer.createActor(MessageSinkActor.class,
				TemplateRegistryActor.OptionsTemplateAvailableRequest.class, 2, notifiedCompletable);

		templateRegistryActor.tell(TemplateRegistryActor.AddNotifiedRequest.builder().notified(notified).build(), null);
		templateRegistryActor.tell(TemplateRegistryActor.StoreOptionTemplateRequest.builder().optionsTemplates(Arrays
				.asList(OptionsTemplate.builder().flowsetId(1).build(), OptionsTemplate.builder().flowsetId(2).build()))
				.build(), null);
	...
	public void shouldFindKnownDataTemplate() {
		...
		final ActorRef replyActor = springActorProducer.createActor(MessageSinkActor.class,
				TemplateRegistryActor.LookupDataTemplateResponse.class, 1, replyCompletable);

		templateRegistryActor.tell(TemplateRegistryActor.StoreDataTemplateRequest.builder()
				.dataTemplates(Arrays.asList(DataTemplate.builder().flowsetId(1).build(),
						DataTemplate.builder().flowsetId(2).build(), DataTemplate.builder().flowsetId(3).build()))
				.build(), null);

		templateRegistryActor.tell(TemplateRegistryActor.LookupTemplateRequest.builder().flowsetId(1).build(),
				replyActor);
	...
	public void shouldNotFindUnknownDataTemplate() {
		...
		final ActorRef replyActor = springActorProducer.createActor(MessageSinkActor.class,
				TemplateRegistryActor.UnknownFlowsetResponse.class, 1, replyCompletable);
		...
		templateRegistryActor.tell(TemplateRegistryActor.LookupTemplateRequest.builder().flowsetId(4).build(),
				replyActor);
	...
	public void shouldFindKnownOptionsTemplate() {
		...
		final ActorRef replyActor = springActorProducer.createActor(MessageSinkActor.class,
				TemplateRegistryActor.LookupOptionsTemplateResponse.class, 1, replyCompletable);

		templateRegistryActor.tell(TemplateRegistryActor.StoreOptionTemplateRequest.builder()
				.optionsTemplates(Arrays.asList(OptionsTemplate.builder().flowsetId(1).build(),
						OptionsTemplate.builder().flowsetId(2).build(), OptionsTemplate.builder().flowsetId(3).build()))
				.build(), null);
