...
public class Netflow9DatagramDecoder extends ChannelInboundHandlerAdapter {
    ...
    private void processDatagramPacket(final Netflow9DecodedDatagram decodedDatagram, final Header header, final InetAddress peerAddress, final ByteBuf in) {
        int recordNumber = 0;
    ...
    private void processTemplateFlowset(final Netflow9DecodedDatagram decodedDatagram, final InetAddress peerAddress, final int recordNumber, final ByteBuf workBuf) {
    ...
    private void processOptionsTemplateFlowset(final Netflow9DecodedDatagram decodedDatagram, final InetAddress peerAddress, final int recordNumber, final ByteBuf workBuf) {
