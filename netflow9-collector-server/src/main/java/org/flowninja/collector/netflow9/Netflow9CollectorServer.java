...
public class Netflow9CollectorServer implements InitializingBean, DisposableBean  {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        b.bind(collectorProperties.getAddress() != null ? collectorProperties.getAddress() : InetAddress.getLocalHost(), collectorProperties.getPort()).addListener(new OpenListener());
    }
